...
const Banner = () => {
    return (
        <div className='banner flex flex-col md:flex-row justify-between items-center shadow-2xl mx-auto px-5 md:px-40 py-20 gap-5'>
            ...
            <div className='space-y-4 w-full order-2 md:order-1'>
                ...
                <h1 className='font-bold text-2xl md:text-6xl leading-snug'>Supercharge Your <br /> Digital Workflow</h1>
            ...
            <img className='w-full order-1 md:order-2' src="/src/assets/banner.png" alt="Tools image" />
        </div>
    );
};
