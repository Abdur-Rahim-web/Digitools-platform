...
const Footer = () => {
    return (
        <div className='px-5 md:px-20 lg:px-40 py-20 bg-[#101727]'>
            {/* footer form daisy ui */}
            <footer className="footer sm:footer-horizontal text-white p-10">
                    <div className='space-y-3'>
                        <h2 className='font-bold text-4xl'>DigiTools</h2>
                        <p className='text-base-200'>Premium digital tools for creators,<br /> professionals, and businesses. Work smarter <br /> with our suite of powerful tools.</p>
                    </div>
                    <nav>
